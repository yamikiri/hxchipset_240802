...
#define HIMAX_DRIVER_VER "3.0.0.26_poplar_01"
...
#define LENOVO_FUN_ENABLE
#if defined(LENOVO_FUN_ENABLE)
	#define Lenovo_direction_fun
	#define Lenovo_game_mode_fun
	#define Lenovo_norch_fun
//	#define Lenovo_support_pen_fun
//	#define Lenovo_penraw_fun
//	#define Lenovo_pen_id_fun
#if defined(Lenovo_penraw_fun)
	#define pen_resolution_10_en
#endif
#endif	
