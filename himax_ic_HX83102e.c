...
struct ic_setup_collect g_hx83102e_setup = {
	...
	._addr_panel_direction	  = ADDR_USB_PANEL_DIRECTION,
#endif
#if defined(Lenovo_game_mode_fun)	
	._addr_game_mode	  	  =	ADDR_GAME_MODE,
#endif
#if defined(Lenovo_support_pen_fun)
	._addr_support_pen	  	  = ADDR_SUPPORT_PEN,
#endif
#if defined(Lenovo_norch_fun)		
	._addr_prevent_notch	  = ADDR_PREVENT_NOTCH,
#endif	
#if defined(Lenovo_pen_id_fun)
	._addr_pen_id_en	      = ADDR_PEN_ID_WT,
	._addr_pen_id_data	      = ADDR_PEN_ID_RD,
#endif	
};
...
#endif
#if defined(Lenovo_direction_fun)
	hx_s_core_fp._set_panel_direction = himax_mcu_set_panel_direction;
	hx_s_core_fp._read_panel_direction = himax_mcu_read_panel_direction;
#endif	
#if defined(Lenovo_game_mode_fun)	
	hx_s_core_fp._set_game_mode = himax_mcu_set_game_mode;
	hx_s_core_fp._read_game_mode = himax_mcu_read_game_mode;
#endif	
#if defined(Lenovo_support_pen_fun)	
	hx_s_core_fp._set_support_pen = himax_mcu_set_support_pen;
	hx_s_core_fp._read_support_pen = himax_mcu_read_support_pen;
#endif	
#if defined(Lenovo_pen_id_fun)	
	hx_s_core_fp._set_pen_id_mode = himax_mcu_set_pen_id_mode;
	hx_s_core_fp._read_pen_id_mode = himax_mcu_read_pen_id_mode;
#endif
#if defined(Lenovo_norch_fun)
	hx_s_core_fp._set_prevent_notch = himax_mcu_set_prevent_notch;
#endif	
}
