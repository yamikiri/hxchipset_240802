...
struct ic_setup_collect {
	...
	uint32_t _addr_panel_direction;
#endif
#if defined(Lenovo_game_mode_fun)	
	uint32_t _addr_game_mode;
#endif
#if defined(Lenovo_support_pen_fun)
	uint32_t _addr_support_pen;
#endif
#if defined(Lenovo_norch_fun)		
	uint32_t _addr_prevent_notch;
#endif	
#if defined(Lenovo_pen_id_fun)
	uint32_t _addr_pen_id_en;
	uint32_t _addr_pen_id_data;
#endif	
};
...
#if defined(Lenovo_direction_fun)
	#define ADDR_USB_PANEL_DIRECTION 	    0x10007f3c
	#define DATA_PANEL_PORTRAIT_0_HDSK_PWD		0x00000000
	#define DATA_PANEL_LANDSCAPE_90_HDSK_PWD		0xA33AA33A
	#define DATA_PANEL_LANDSCAPE_180_HDSK_PWD	0xA55AA55A
	#define DATA_PANEL_LANDSCAPE_270_HDSK_PWD	0xA11AA11A 
#endif	
#if defined(Lenovo_game_mode_fun)
	#define ADDR_GAME_MODE					0x10007fe0
	#define DATA_GAME_MODE_ENABLE			0xA55A0000
	#define DATA_NORMAL_MODE_ENABLE			0xA55AA55A
	#define DATA_PEN_MODE_ENABLE			0x0000A55A
#endif
#if defined(Lenovo_support_pen_fun)
	#define ADDR_SUPPORT_PEN				0x10007410
	#define DATA_SUPPORT_PEN_DISABLE		0x00000000
	#define DATA_SUPPORT_PEN_ENABLE			0x3AA33AA3
#endif	
#if defined(Lenovo_pen_id_fun)
	#define ADDR_PEN_ID_WT  				0x10007418
	#define ADDR_PEN_ID_RD  				0x1000741c
	#define DATA_PEN_ID_RD_EN				0xA55AA55A
	#define DATA_PEN_ID_RD_DIS				0x00000000
	#define DATA_PEN_ID_RD_DOING			0xA33AA33A
	#define DATA_PEN_ID_RD_OVER				0x5AA55AA5
	#define DATA_RTN_AP_PEN_ID_OK			0xA55A
	#define DATA_RTN_AP_PEN_ID_ERR			0x5AA5
	#define DATA_RTN_AP_PEN_ID_NOT_START	0x0000
#endif
#if defined(Lenovo_norch_fun)
	#define ADDR_PREVENT_NOTCH				0x1000727c	
#endif
...
#if defined(Lenovo_direction_fun)
	void (*_set_panel_direction)(uint8_t direction);
	uint8_t (*_read_panel_direction)(void);
#endif	
#if defined(Lenovo_game_mode_fun)	
	void (*_set_game_mode)(uint8_t mode);
	uint8_t (*_read_game_mode)(void);
#endif	
#if defined(Lenovo_support_pen_fun)	
	void (*_set_support_pen)(uint8_t mode);
	uint8_t (*_read_support_pen)(void);
#endif	
#if defined(Lenovo_pen_id_fun)	
	void (*_set_pen_id_mode)(uint8_t mode);
	uint16_t (*_read_pen_id_mode)(void);
#endif
#if defined(Lenovo_norch_fun)
	int (*_set_prevent_notch)(int32_t *data);
#endif	
/*Inspection*/
...
#endif
#if defined(Lenovo_direction_fun)
extern void himax_mcu_set_panel_direction(uint8_t direction);
extern uint8_t himax_mcu_read_panel_direction(void);
#endif
#if defined(Lenovo_game_mode_fun)
extern void himax_mcu_set_game_mode(uint8_t mode);
extern uint8_t himax_mcu_read_game_mode(void);
#endif
#if defined(Lenovo_support_pen_fun)
extern uint8_t himax_mcu_read_support_pen(void);
extern void himax_mcu_set_support_pen(uint8_t mode);
#endif
#if defined(Lenovo_pen_id_fun)	
extern void himax_mcu_set_pen_id_mode(uint8_t mode);
extern uint16_t himax_mcu_read_pen_id_mode(void);
#endif
#if defined(Lenovo_norch_fun)
extern int himax_mcu_set_prevent_notch(int32_t *data);
#endif
